...
import { FaGraduationCap, FaSignInAlt, FaUserPlus, FaBars, FaTimes, FaSignOutAlt, FaTachometerAlt } from 'react-icons/fa';
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-lg border-b border-gray-800 shadow-lg transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-gradient-to-r from-red-800 to-red-700 rounded-xl flex items-center justify-center">
      ...
      {/* Mobile menu */}
      <div className={`md:hidden absolute top-full left-0 right-0 bg-gray-900/95 backdrop-blur-lg border-b border-gray-800 shadow-lg transition-all duration-300 ${
