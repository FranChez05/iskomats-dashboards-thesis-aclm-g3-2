      ...
      return (
        <section className="bg-white p-6 rounded-xl shadow-sm">
          <div className="flex items-center justify-between gap-3 flex-wrap mb-6">
            <h3 className="text-xl font-semibold text-[#800020]">Tulong-Tulong - Manage Posts</h3>
            <button
              type="button"
              onClick={() => {
                resetForm();
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={(e) => { e.preventDefault(); saveScholarshipPost(); }}>
          <div>
            ...
            <input
              ...
              placeholder="e.g. Tulong-Tulong Scholarship 2026"
              required
            />
          </div>
          <div>
