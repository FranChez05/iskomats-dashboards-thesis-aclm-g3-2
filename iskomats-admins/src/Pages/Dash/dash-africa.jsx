...
export default function DashAfrica() {
  ...
  const [section, setSection] = useState('track'); // manage | track | reports | inbox | view-applicant
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div>
            <h3 className="text-2xl font-bold text-[#800020]">Africa Scholarship Analytics</h3>
          ...
          {[
            ...
            >
              <span className="flex items-center gap-2">
                ...
                {item.id === 'reports' && <FaTachometerAlt />}
